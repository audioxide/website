...
export default defineNuxtConfig({
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileColor', content: '#121212' },
      {
        ...
        content: `${SITE_URL}/ms-icon-144x144.png`
      },
      ...
      { hid: 'og:url', property: 'og:url', content: `${SITE_URL}/` },
      {
        ...
        property: 'og:image',
        content: `${SITE_URL}/social-tile-3-2.png`
      },
      {
        hid: 'og:image-standard:type',
      ...
      },
      {
        ...
        content: 'Audioxide branded social tile'
      },
      {
        hid: 'og:image-square',
        property: 'og:image',
        content: `${SITE_URL}/social-tile-1-1.png`
      },
      {
        hid: 'og:image-square:type',
        property: 'og:image:type',
        content: 'image/png'
      },
      {
      ...
      { hid: 'twitter:title', name: 'twitter:title', content: SITE_NAME },
      {
        hid: 'twitter:image',
        name: 'twitter:image',
        content: `${SITE_URL}/social-tile-2-1.png`
      },
      {
   ...
   */
  plugins: [{ src: '~plugins/goatcounter.js', mode: 'client' }],
  /*
   ** Nuxt.js dev-modules
   */
  buildModules: [
  ...
  build: {
    ...
    plugins: [
      new SitemapPlugin({
        base: SITE_URL,
        paths: routes
          .filter((urlPath) => !urlPath.startsWith('/tags/'))
          .map((urlPath) => ({
            path: urlPath,
            lastMod: true,
