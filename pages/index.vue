<template>
  <main>
    ...
    <div class="panel reviews">
      <h3>
        Album Reviews (<nuxt-link no-prefetch to="/reviews/"
          >See all<span class="sr-only">reviews</span></nuxt-link
        >)
      </h3>
      <div class="listing">
        <review-link
    ...
    <div class="panel articles">
      <h3>
        Articles (<nuxt-link no-prefetch to="/articles/"
          >See all<span class="sr-only">articles</span></nuxt-link
        >)
      </h3>
      <div class="listing">
    ...
    <div class="panel interviews">
      <h3>
        Interviews (<nuxt-link no-prefetch to="/interviews/"
          >See all<span class="sr-only">interviews</span></nuxt-link
        >)
      </h3>
      <div class="listing">
        <article-link
          v-for="(item, key) in interviews"
          :key="key"
          :post="item"
          :author="false"
        />
    ...
    <div class="panel listening-parties">
      <h3>
        Listening Parties (<nuxt-link no-prefetch to="/listening-parties/"
          >See all<span class="sr-only">listening parties</span></nuxt-link
        >)
      </h3>
      <div class="listing">
        <article-link
          v-for="(item, key) in listeningParties"
          :key="key"
          :post="item"
          image-size="xsmall"
          image-format="square"
    ...
    <div class="panel funnyfarm">
      <h3>
        Funnyfarm (<nuxt-link no-prefetch to="/funnyfarm/"
          >See all<span class="sr-only">funnyfarm articles</span></nuxt-link
        >)
      </h3>
      <div class="listing">
        <article-link
          v-for="(item, key) in funnyfarm"
          :key="key"
          :post="item"
          :author="false"
        />
...
export default Vue.extend({
  ...
  asyncData({ store }) {
    return Promise.all([store.dispatch('posts/getLatestData')])
  },
  data: () => SITE_CONSTANTS,
  head() {
    return {
      ...
      meta: [
        {
          ...
          content: 'aAaGDXrBixmXjHGSOVCBJexlPGi6VtPyX_WOSLhcKFs',
        },
        {
          name: 'p:domain_verify',
          content: 'd1fcf92cdd3b4392d1c76473f6ccae89',
        },
      ],
    }
  },
