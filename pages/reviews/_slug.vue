        ...
        <aside class="review-sidebar">
            ...
            <figure>
                ...
                <template v-if="review.metadata.artworkCredit">
                    <figcaption class="review-sidebar__artwork-info" v-if="showCredit">The album artwork of <span class="album">{{ review.metadata.album }}</span> by {{ review.metadata.artist }} {{ review.metadata.artworkCredit }} <template v-if="review.metadata.artworkCreditSource"><a :href="review.metadata.artworkCreditSource" target="_blank" rel="noopener"><icon :icon="['fa', 'external-link-alt']" /></a></template>
                    </figcaption>
